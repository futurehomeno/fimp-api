...
| `cable_current`    | `"16"`                        | No       | Maximum current in `A` supported by the cable. Reading is available only when cable is plugged. Might not be supported by all chargers. |
