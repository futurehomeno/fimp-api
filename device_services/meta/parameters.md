...
| `device_lock`             | Device lock             | `int`      | `thermostat` or `power_regulator` service | Configure lock setting of the heating device.                                                                                                                                                                                                    |
| `used_sensors`            | Used sensor             | `int`      | `thermostat` service                      | Set sensor type,which will be use to calculate heater setting                                                                                                                                                                                    |
| `floor_sensor_resistance` | Floor sensor resistance | `int`      | `thermostat` service                      | Set he kΩ floor sensor rating, if is installed                                                                                                                                                                                                   |