...
|---------------------------|-------------------------|--------------------------------|------------|-------------|--------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `cable_always_locked`     | Cable always locked     | `chargepoint`                  | `bool`     | `select`    | `true`, `false`                                        | Allows to enforce charging cable to be always locked on the EVSE side to prevent theft.                                                                                                                                                     |
| `free_charging`           | Free charging           | `chargepoint`                  | `bool`     | `select`    | `true`, `false`                                        | Determines whether chargepoint should automatically start charging an EV without an authorization or remote control trigger.                                                                                                                |
