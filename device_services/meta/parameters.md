...
|-----------------------|---------------------|------------|-------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------|
| `heat_controll_mode`  | Heat control mode   | `string`   | `thermostat` or `power_regulator` service | Allows to switching heating control mode between thermostat and power regulator. Accepted values are `reg` for power regulator and `tht` for thermostat. |
