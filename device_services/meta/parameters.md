...
| `device_lock`             | Device lock             | `thermostat`,`power_regulator` | `string`   | `select`    |              | Configure lock setting of the thermostat device.                                                                                                                                                                                            |
| `used_sensors`            | Used sensors            | `thermostat`                   | `string`   | `select`    |              | Select which sensors should be used by the thermostat to calculate heating hysteresis.                                                                                                                                                      |
