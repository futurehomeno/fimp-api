...
|------|-----------------------------|------------|-------------------------------------------------------|------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| in   | cmd.meter.get_report        | string     |                                                       |                  | Value is an import/consumption `unit` defined in <br/>[`sup_units`](#service-properties) property. May not be supported by all meters. Empty value should request all supported units. |
