...
| address      | string    | `"/rt:dev/rn:zw/ad:1/sv:out_bin_switch/ad:21_0"` | An address of the service starting from a resource type segment. Service address segment should contain thing address and optional group identification. See [topic format](/fimp/topic_format.md#topic-segments) for more details. |
